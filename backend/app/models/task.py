...
class Task(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    __tablename__ = "tasks"
    __table_args__ = (UniqueConstraint("company_id", "project_id", "name", name="uq_tasks_project_name"),)
    ...
    stage: Mapped[str] = mapped_column(String(80), nullable=False, default="new_requests", index=True)
    ...
    checklist_items = relationship(
        "TaskChecklistItem", cascade="all, delete-orphan", lazy="selectin", order_by="TaskChecklistItem.position"
    )
